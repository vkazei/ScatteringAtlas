...
\ddplot{SVSH/SVSHCij}{SVSH/SVSHnPar0}{Same as \figref{PP_Full/PPCij_Full}, but for $SV-SH$ scattering, which is sensitive to all the $C_{ij}$ parameters except $C_{33}$.}
